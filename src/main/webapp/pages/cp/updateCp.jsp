    ...
    $(document).ready(function () {
    	$.formValidator.initConfig({
    		 ...
    		 onSuccess:function(){
   				...
   				var options = {
   					url: "<%=request.getContextPath()%>/cp/doUpdateCp.do",
   			        success: function (data){
   			        	if(data=="OK"){
   			        		jQuery("#msgTip").attr("class","onCorrect");
   			        		jQuery("#msgTip").html("更新成功！");
   			        		if(cpId==null || cpId==""){
   			        			document.location.href="<%=request.getContextPath()%>/cp/toCpList.do";
   			        		}
   			        	}else{
    	...
    	$("#fullName").formValidator({
			...
			dataType : "html",
			async : true,
			url : "<%=request.getContextPath()%>/cp/verifyCpName.do?cpId="+jQuery("#cpId").val(),
			success : function(data){
...
<body>
	<div class="home_content_bg">
			<a class="home_current">供应商</a>
	</div>
	<div class="content-mainBG" style="min-width: 950px;">
	<form id="frm" name="frm" method="post">
	<input type="hidden" id="cpId" name="cpId" value="${cp.cpId}" />
    <table class="table-add" width="100%" border="0" cellpadding="0" cellspacing="0" style="min-width: 950px;">
        <tbody>
           ...
           <tr>
                ...
                <c:if test="${cp!=null}">
                <td width="20%">
                    <input name="abbrName" id="abbrName" type="text" class="inputText" value="${cp.abbrName}"  />
                </td>
                <td width="40%">
                	<div id="abbrNameTip"></div>
                </td>
           ...
           <tr>
                ...
                <td width="30%" >
                   <input type="text" style="width: 250px;" name="contactor" id="contactor" value="${cp.contactor}" />
                </td>
                <td width="30%">
           ...
           <tr>
                ...
                <td width="30%" >
                   <input type="text" style="width: 250px;" name="tel" id="tel" value="${cp.tel}" />
                </td>
                <td width="30%">
                	<div id="telTip"></div>
                </td>
           ...
           <tr>
                ...
                <td width="30%" >
                   <input type="text" style="width: 250px;" name="email" id="email" value="${cp.email}" />
                </td>
                <td width="30%">
                	<div id="emailTip"></div>
                </td>
           ...
           <tr>
                ...
                <td width="30%" >
                   <input type="text" style="width: 250px;" name="qq" id="qq" value="${cp.qq}" />
                </td>
                <td width="30%">
                	<div id="qqTip"></div>
                </td>
