...
function addContract(channelId) {
	var root ='<%=request.getContextPath()%>';
	var url = "iframe:"+root+"/channel/toAddChannelContract.do?channelId="+channelId;
	tipsWindown("新增合同",url,"1024","768","true","","true","","");
}

function updateContract(channelId,contractId) {
	var root ='<%=request.getContextPath()%>';
	var url = "iframe:"+root+"/channel/toUpdateChannelContract.do?channelId="+channelId+"&contractId="+contractId;
...
<body>
	...
	<div class="titleShow">渠道名称：${channel.fullName}</div>
	...
	<input type="hidden" id="channelId" name="channelId" value="${channel.channelId}" />
        ...
        <tbody>
        	...
        	<tr>
                ...
                <td>
                	<input class="def_but" type="button" onclick="updateContract('${channel.channelId}','${c.contractId }')"  value="修改" />
        ...
        <tfoot>
        	<tr>
                <td colspan="9" align="center">
                    <input class="defaultBut" type="button" id="addc" onclick="addContract('${channel.channelId}')" value="新增合同" />
