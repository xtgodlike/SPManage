...
<head>
    ...
    $(document).ready(function () {
    	...
    	//模块代码
    	$("#moduleCode").formValidator({
    		onShow:"",
    		onFocus:"请输入模块代码，1~20个字母",
    		onCorrect:"正确"
    	}).inputValidator({
    		min:1,
    		max:32,
...
<body>
	<div class="home_content_bg">
		<a class="home_current">添加模块</a>
	</div>
	<div class="content-mainBG">
 	<form id="frm" name="frm" action="<%=path%>/basics/doAddModule.do" method="post">
    <table class="table-add" border="0" cellpadding="0" cellspacing="0">
        <tbody>
            <tr>
                <td width="40%" align="right"><font color="FF0000">*</font>父模块：</td>
                <td width="30%">
                	<input type="hidden" name="parentModuleId" id="parentModuleId" value="${module.moduleId}"  />
                    ${module.moduleName}
                </td>
            ...
            <tr> 
                ...
                <td>
                     <input name="moduleName" id="moduleName" class="inputText" type="text" />
                </td>
                <td>
            ...
            <tr>
                ...
                <td style="font-size: 12px;">
                    ...
                    ${module.moduleCode}<c:if test="${module.moduleCode!=null}">.</c:if><input name="moduleCode" id="moduleCode" class="inputText" type="text" maxlength="50" />
                </td>
                <td>
                	<div id="moduleCodeTip"></div>&nbsp;
                </td>
            </tr>
            <tr>
                <td align="right">模块链接：</td>
                <td>
                    <input name="moduleLink" id="moduleLink" class="inputText" type="text" maxlength="50" />
                </td>
                <td>
            ...
            <tr>
                <td align="right"><font color="FF0000">*</font>模块类型：</td>
                <td>
              ...
              <tr> 
                ...
                <td>
                     <input name="showSeq" class="inputText" id="showSeq" type="text"  />
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <textarea name="moduleDesc" id="moduleDesc" rows="4" cols="5" class="textareaText" ></textarea>
                </td>
                 <td>
        ...
        <tfoot>
            <tr>
                <td colspan="3">
                    <input class="defaultBut" type="submit" value="添加模块" />
