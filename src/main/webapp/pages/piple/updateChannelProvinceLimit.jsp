 			...
 			var options = {
 		        ...
 		        success: function (data){
 		        	...
 		        	if(rs[0]=="DAYEXCESS"){
 		        		...
 		        		jQuery("#msgTip").html("渠道省份分配日限额已超过渠道日限总额："+rs[1]+"。配置失败！");
 		        	}
 		        	if(rs[0]=="MONTHEXCESS"){
 		        		jQuery("#msgTip").attr("class","onError");
 		        		jQuery("#msgTip").html("渠道省份分配月限额已超过渠道月限总额："+rs[1]+"。配置失败！");
 		        	}
 		        	if(rs[0]=="FAIL"){
 		        		jQuery("#msgTip").attr("class","onError");
...
<body>
	...
	<div class="titleShow">所属通道：${piple.pipleName}  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;所属渠道：${channel.fullName}</div>
        ...
        <thead>
        	<tr>
                <td colspan="3" align="center" width="100%">
                  <div style="width: 400px;" id="msgTip"></div>
                </td>
                 </td>
            </tr>
