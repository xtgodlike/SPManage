    	...
    	$.formValidator.initConfig({
    		 ...
    		 onSuccess:function(){
    			// 更新提示信息
   				...
   				var options = {
   					url: "<%=request.getContextPath()%>/piple/doUpdatePipleContract.do",
   			        success: function (data){
   			        	if(data=="OK"){
   			        		...
   			        		alert("更新成功！");
   			        		closeEigsx();
   			        		parent.document.location.href="<%=request.getContextPath()%>/piple/toPipleContractlList.do?pipleId="+pipleId;
   			        	}else{
