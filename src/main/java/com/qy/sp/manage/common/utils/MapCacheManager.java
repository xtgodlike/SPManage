...
public class MapCacheManager {  
	...
	public static final String KEY_PRARM_MAP = "KEY_PRARM_MAP";
    ...
    public CacheProvider getSmsOrderCache(){
    	if(!TimerTask.containsClearDailyKey(KEY_SMS_ORDER_MAP)){
    		TimerTask.putClearDailyKey(KEY_SMS_ORDER_MAP);
    	}
        return getCustomCacheProvider(KEY_SMS_ORDER_MAP);  
    } 
    public CacheProvider getDailyClearMapCache(){  
    	if(!TimerTask.containsClearDailyKey(KEY_DAILY_CLEAR_MAP)){
    		TimerTask.putClearDailyKey(KEY_DAILY_CLEAR_MAP);
    	}
        return getCustomCacheProvider(KEY_DAILY_CLEAR_MAP);  
    } 
    public CacheProvider getParameterMapCache(){  
        return getCustomCacheProvider(KEY_PRARM_MAP);  
    } 
